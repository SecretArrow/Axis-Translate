 ...
 * Devanagari — every script family ML Kit ships a dedicated recognizer for)
 * run sequentially over the same image; the result carrying the longest
 * non-blank text wins. Everything runs on device — no network access.
 */
